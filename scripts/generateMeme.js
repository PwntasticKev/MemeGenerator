...
export async function callCustomGpt (topic, accountNumber = 1) {
  try {
    ...
    const prompt = `Create a THOUGHT-PROVOKING viral meme about "${topic}" that will spark meaningful discussions and get people to share their perspectives. 

Requirements:
1. Generate an INSIGHTFUL fact or observation about ${topic} (max 100 characters) - something that reveals deeper meaning, hidden details, or alternative interpretations that make people think
2. Create an ENGAGING reply that encourages discussion and different viewpoints (max 80 characters) - NO EMOJIS
...
{
  "fact": "Your insightful fact/observation here",
...
- The fact should reveal deeper meaning, hidden details, or alternative interpretations that make people think
- Focus on: deeper symbolism, character motivations, plot implications, what could have happened, missed opportunities, character development, world-building details
- Use phrases like: "actually means", "could have been", "hidden detail", "deeper meaning", "missed opportunity", "character arc", "symbolism"
- Make people want to discuss and share their own interpretations
- Examples: "X actually represents Y", "What if Z happened instead?", "The real meaning behind A", "B could have been so much more", "Hidden detail in C"
...
- Username and handle should be creative but not realistic person names (e.g., "@meme_lord", "MemeLord", "@cinema_guru", "CinemaGuru" - not "@alex_thompson" or "Alex Thompson")
- Handle should be a creative social media username that's memorable and fun
